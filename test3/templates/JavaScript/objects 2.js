...
function displayProducts(){
    ...
    $.each(products,function (k,v){
      ...
      var prod = '<div class="col-sm-6 col-md-4 col-lg-6">'+
        ...
        prod += ' <button  onclick="addProductToShoppingCart('+v.id+',$(this).prev().val())'+'" style="padding: 2px 50px 2px 50px" class="btn btn-primary">Add to Cart</button>';
        prod +='</div>';
...
function displayCart(){
    ...
    cartDisplay += ' <a type="button" href="checkout.html" style="margin-top: 25px; float: right; padding: 2px 50px 2px 50px" class="btn btn-danger">cheack out</a>';
